...
//длина которых меньше, либо равна 3 символам. Первоначальный массив можно ввести с клавиатуры, либо задать на старте выполнения алгоритма. При решении не рекомендуется пользоваться коллекциями, лучше обойтись
// исключительно массивами.

string[] workArray = FillArray();
string[] resultArray = CreateNewArray(workArray);
...
string[] FillArray()
{
    Console.WriteLine("Введите данные и нажмите Enter: ");
...
string[] CreateNewArray(string[] workArray)
{
